  ...
  return (
    <BuyerLayout>
      <div className="mx-auto max-w-lg px-4 py-16">
        ...
        <h1 className="mt-2 font-serif text-4xl font-bold text-[#241532]">Open a bakery menu you were sent</h1>
        ...
        <form onSubmit={openMenu} className="mt-8 space-y-3">
          <input
            className="h-12 w-full rounded-xl border border-[#ded6ca] bg-white px-4 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/15"
