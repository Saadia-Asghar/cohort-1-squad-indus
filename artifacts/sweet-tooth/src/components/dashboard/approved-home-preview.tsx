      ...
      <div className="mx-auto max-w-[1480px]">
        <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_264px]">
          ...
          <aside className="space-y-4">
            <section className="overflow-hidden rounded-2xl border border-[#e5cfd9] bg-[#fff0f5] shadow-[0_12px_34px_rgba(47,24,55,0.05)]">
              <div className="px-4 pt-4">
                <p className="font-serif text-lg font-semibold text-[#632a73]">
                  Hi Sana!
                </p>

                <p className="mt-1 text-xs text-[#746876]">
                  Let&apos;s keep building your bakery.
                </p>
              </div>

              <div className="mx-4 mt-4 grid min-h-[170px] place-items-center rounded-2xl border border-dashed border-[#dcb8c8] bg-white/45">
                <div className="text-center">
                  <Sparkles className="mx-auto h-8 w-8 text-[#c24f7a]" />

                  <p className="mt-3 text-xs font-semibold text-[#632a73]">
                    3D mascot area
                  </p>

                  <p className="mt-1 text-[11px] text-[#746876]">
                    Added in checkpoint 3
                  </p>
                </div>
              </div>

              <div className="mt-4 border-t border-[#e5cfd9] p-4">
                <div className="flex items-center justify-between text-[11px]">
                  <span className="font-semibold">Setup progress</span>
                  <span className="text-[#746876]">3 of 7 completed</span>
                </div>

                <div className="mt-2 h-2 overflow-hidden rounded-full bg-[#f1d9e3]">
                  <div className="h-full w-[43%] rounded-full bg-[#c24f7a]" />
                </div>

                <div className="my-4 h-px bg-[#e5cfd9]" />

                <p className="text-[10px] font-bold uppercase tracking-[0.12em] text-[#c24f7a]">
                  Next mission
                </p>

                <h2 className="mt-2 font-serif text-[1.15rem] font-semibold leading-tight">
                  Add your delivery areas
                </h2>

                <p className="mt-2 text-xs leading-5 text-[#746876]">
                  So your assistant can confirm delivery with customers.
                </p>

                <Link
                  href="/dashboard/settings"
                  className="mt-4 flex min-h-11 items-center justify-center rounded-xl bg-[#632a73] px-4 text-sm font-semibold text-white"
                >
                  Continue setup
                </Link>
                ...
                <Link
                  href="/dashboard/settings"
                  className="mt-2 flex min-h-10 items-center justify-center gap-2 text-xs font-semibold text-[#c24f7a]"
                >
