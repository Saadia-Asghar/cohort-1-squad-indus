  ...
  return (
    <section id="pricing" className="scroll-mt-20 bg-muted px-4 py-16 md:py-20">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-7 text-center text-sm text-muted-foreground">Want to start now? <Link href="/dashboard/register" className="font-semibold text-primary hover:underline">Create a free account</Link> with the menu agent. Paid channels can be added when you are ready.</p>
      </div>
    </section>
  );
}
