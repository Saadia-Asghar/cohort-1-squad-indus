...
import { bakersTable, productsTable, customersTable, ordersTable, reviewsTable } from "@workspace/db/schema";
...
async function seedBaker(bakerData: typeof requestedBakers[0]) {
  ...
  const item = (product: typeof p0, qty = 1) => ({
  ...
  const orderSpecs = [
    { buyer: zara, area: bakerData.areas[0], items: [item(p0)], totalPkr: p0.basePricePkr, daysBack: 0, status: "new", paymentStatus: "pending", source: "marketplace" as const, occasion: "Birthday" },
    { buyer: hira, area: bakerData.areas[1] ?? bakerData.areas[0], items: [item(p1)], totalPkr: p1.basePricePkr, daysBack: 1, status: "confirmed", paymentStatus: "pending", source: "baker_whatsapp" as const, occasion: null },
    { buyer: ayesha, area: bakerData.areas[0], items: [item(p0), item(p1, 2)], totalPkr: p0.basePricePkr + p1.basePricePkr * 2, daysBack: 3, status: "in_production", paymentStatus: "pending", source: "instagram_dm" as const, occasion: "Dawat" },
    { buyer: bilal, area: bakerData.areas[1] ?? bakerData.areas[0], items: [item(p0)], totalPkr: p0.basePricePkr, daysBack: 6, status: "delivered", paymentStatus: "paid", source: "marketplace" as const, occasion: "Anniversary" },
    { buyer: zara, area: bakerData.areas[0], items: [item(p1)], totalPkr: p1.basePricePkr, daysBack: 10, status: "delivered", paymentStatus: "paid", source: "marketplace" as const, occasion: "Eid" },
    { buyer: ayesha, area: bakerData.areas[0], items: [item(p0)], totalPkr: p0.basePricePkr, daysBack: 18, status: "delivered", paymentStatus: "paid", source: "baker_whatsapp" as const, occasion: null },
    { buyer: hira, area: bakerData.areas[2] ?? bakerData.areas[0], items: [item(p1)], totalPkr: p1.basePricePkr, daysBack: 25, status: "delivered", paymentStatus: "paid", source: "instagram_dm" as const, occasion: "Birthday" },
    { buyer: omar, area: bakerData.areas[3] ?? bakerData.areas[0], items: [item(p0)], totalPkr: p0.basePricePkr, daysBack: 35, status: "delivered", paymentStatus: "paid", source: "manual" as const, occasion: null },
    { buyer: zara, area: bakerData.areas[0], items: [item(p0), item(p1)], totalPkr: p0.basePricePkr + p1.basePricePkr, daysBack: 48, status: "delivered", paymentStatus: "paid", source: "marketplace" as const, occasion: "Party" },
    { buyer: bilal, area: bakerData.areas[1] ?? bakerData.areas[0], items: [item(p1)], totalPkr: p1.basePricePkr, daysBack: 52, status: "delivered", paymentStatus: "paid", source: "baker_whatsapp" as const, occasion: null },
    { buyer: ayesha, area: bakerData.areas[0], items: [item(p0)], totalPkr: p0.basePricePkr, daysBack: 57, status: "delivered", paymentStatus: "paid", source: "marketplace" as const, occasion: "Eid" },
    { buyer: hira, area: bakerData.areas[2] ?? bakerData.areas[0], items: [item(p1)], totalPkr: p1.basePricePkr, daysBack: 12, status: "cancelled", paymentStatus: "pending", source: "marketplace" as const, occasion: null, cancel: { reason: "Customer changed delivery date", by: "customer" } },
  ];
